   ...
   return (
      <div className="flex flex-col w-full">
         ...
         <div className="hero h-[100vh] w-full flex items-end relative object-cover">
            ...
            <div className="pb-[30px] lg:pb-[100px] pl-6 lg:pl-10 space-y-6 absolute z-50 text-white">
               <div className="space-y-2">
                  <p className="text-6xl">Baristan</p>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 h-[100vh]">
            <div className="pl-6 lg:pl-10 h-full w-full col-span-1 flex flex-col gap-4 justify-center items-start bg-[#161a1d] text-white">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 h-[100vh]">
            <div className="bg-white text-black pl-6 lg:pl-10 h-full w-full col-span-1 flex flex-col gap-4 justify-center">
               <div>
         ...
         <div className="hero h-[100vh] w-full flex items-end relative object-cover">
            ...
            <div className="pb-[30px] lg:pb-[100px] pl-6 lg:pl-10 space-y-6 absolute z-50 text-white">
               <div className="space-y-2">
                  <p className="text-6xl">Electric Russian Samovar</p>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 h-[100vh]">
            <div className=" text-white bg-[#56101a] pl-6 lg:pl-10 h-full w-full col-span-1 flex flex-col gap-4 justify-center">
               <div>
                  <h2 className="text-6xl font-bold">
